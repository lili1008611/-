...
namespace CourseManager.Controllers
{
    public class SideBarController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Controller,Ation")] SideBars sideBars)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Controller,Ation")] SideBars sideBars)
        {
            if (ModelState.IsValid)
            {
